...
<head>
  ...
  <title>Start Writing - Kalaa</title>
  <link rel="stylesheet" href="startwriting.css" />
</head>
<body>
  <header class="header">
  ...
  <main class="writing-container">
    <section class="writing-section">
      <h1>✍️ Start Writing</h1>
      <p>Share your creativity with the world and connect with fellow storytellers.</p>
      <div class="writing-options">
        <a href="submitstory.jsp" class="writing-btn">Submit Your Story</a>
        <a href="community.html" class="writing-btn">Join Community</a>
      </div>
    </section>
  </main>
  <footer class="footer">
